...
public static class Extensions_Image
{
    ...
    /// カラーの RGB 値を変更します
    /// </summary>
    public static void SetRGB(this Image self, int hexrgb)
    {
        float r = ((hexrgb >> 16) & 0xff) / 255.0f;
        float g = ((hexrgb >> 8)  & 0xff) / 255.0f;
        float b = ( hexrgb        & 0xff) / 255.0f;
